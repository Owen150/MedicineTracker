                                ...
                                <td>
                                    <div class="row">
                                        <div class="d-flex">
                                            ...
                                            <form action="{{ url('financialYear/'.$financialYear->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
...
{{-- <div class="row">
    <div class="d-flex">
        <div class="mr-3">
            <a href="{{ url('financialYear/' .$finance->id . '/edit') }}"
                class="btn btn-sm btn-success mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                    <path
        ...
        <div class="ml-3 pl-3" style="padding-left:5px;">
            <form action="{{ url('financialYear/'.$finance->id) }}" method="post">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-sm btn-danger">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
