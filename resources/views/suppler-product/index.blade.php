...
<nav class="page-breadcrumb rights-nav">
  ...
  <div class="btn-div">
    ...
    <a href="{{route('suppler-products.create')}}"><button type="button" class="btn btn-primary mb-1 mb-md-0" >Add Supplier Product</button></a>
...
<div class="modal fade" id="receiveModal" tabindex="-1" aria-labelledby="receiveModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('excel_suppliers_upload')}}" method="post" enctype="multipart/form-data">
          @csrf
...
@push('custom-scripts')
  ...
  <script >
    ...
    function getData() {
      $.ajax({
        type: "GET",
        url: "{{ route('suppler_products_data') }}",
        processData: false,
        contentType: false,
        cache: false,
