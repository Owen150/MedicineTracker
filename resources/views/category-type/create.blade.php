  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-muted mb-4">Add category type details to the system</p>
        <form id="signupForm">
          ...
          <div class="row mb-3">
              <div class="col-md-12">
                  ...
                  <input id="name" class="form-control" name="name" type="text" autocomplete="off" required placeholder="Type Name">
              </div>
