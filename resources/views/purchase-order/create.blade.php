        ...
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select  name="period" class="form-select" data-width="100%">
                ...
                <table class="table scroll table-hover" >
                    ...
                    <tbody  id="table-body">
                        ...
                        <tr>
                            ...
                            <th scope="col" colspan="2">
                                <input id="input"  class="grand_total" name="grand_total" readonly type="text" placeholder="Default input" aria-label="default input example" required>
                            </th>
                            <th scope="col"></th>
                            <th scope="col" ></th>
                        </tr>
