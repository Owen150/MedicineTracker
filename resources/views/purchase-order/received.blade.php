...
<form method="POST" action="{{ url('purchase-order/'.$order->id) }}">
    @csrf
    @method('PUT')
                    ...
                    <div class="row d-flex">
                        ...
                        <div class="col-sm-3">
                            <div style="text-align:end">
                                <a href="{{ url('purchase-order-details/' .$order->id    . '/edit') }}" class="btn btn-primary">Edit Purchase Order</a>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div style="text-align:end">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input id="designation" class="form-control" name="order_number" type="text"
                                autocomplete="off" required placeholder="Order Number" required>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea name="delivery_note" id="maxlength-textarea" class="form-control"
                                id="defaultconfig-4" maxlength="100" rows="4"
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                            <div style="text-align:end">
                                <a href="{{ url('purchase-order-detail') }}" class="btn btn-md btn-primary">Add Purchases</a>
                            </div>
                            {{-- <a href="{{ url('purchase-order-detail') }}" class="btn btn-sm btn-primary">Add Purchases</a> --}}
                        </div>
                    </div>
                        ...
                        <table class="table scroll table-hover">
                            ...
                            <tbody id="table-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="input" class="price" name="price[]" readonly type="text"
                                            placeholder="0.00" aria-label="default input example" autocomplete="off"
                                            value="{{$details->price}}">
                                    </td>
                                    <td>
                                        <input class="code" name="code[]" id="input" readonly type="text"
                                            placeholder="code" aria-label="default input example" autocomplete="off">

                                    </td>
                                    <td>
                                        <input oninput="getQty(this)" name="qty_ordered[]" id="input" class="qty"
                                    ...
                                    <td>
                                        <input id="input" type="text" name="qty_recived[]" placeholder="0"
                                            aria-label="default input example" autocomplete="off">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input id="input" readonly class="rowTotal" name="rowtotal[]" type="text"
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <input id="input" readonly class="subTotal" type="text"
                                            placeholder="Default input" aria-label="default input example">
                                    </th>
                                    <th style="padding: 0; margin: 0;">

                                        <div id="add"
                                            style="background: #bbf7d0; border-radius:0.15rem; border: 0.7px solid #4ade80; margin-top: 15px"
                                            class="text-center pt-1"><i class="fa-solid fa-plus"
                                                style="color: #4ade80; font-size: 18px; "></i></div>
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <th scope="col">VAT</th>
                                    <th scope="col">
                                        <input id="input" name="vat" type="text" placeholder="Default input"
                                            aria-label="default input example" autocomplete="off">
                                    </th>
                                    <th scope="col"></th>
                                </tr>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <input id="input" name="discount" type="text" placeholder="Default input"
                                            aria-label="default input example" autocomplete="off">
                                    </th>
                                    <th scope="col"></th>
                                </tr>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <input id="grand_total" name="grand_total" readonly type="text"
                                            placeholder="Default input" aria-label="default input example">
                                    </th>
                                    <th scope="col"></th>
                                </tr>
