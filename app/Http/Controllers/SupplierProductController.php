...
class SupplierProductController extends Controller
{
    ...
    public function excelDownload(Request $request)
    {
        ...
        $checkSupplierId = SupplierProduct::where('id','=',$request->supplier)->first();

        

        if ($checkSupplierId) {
            return Excel::download(new ExistingSupplierProductExport($checkSupplierId->id), $supplierId->name.'_supplier.xlsx');
        }
